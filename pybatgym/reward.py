...
class DefaultRewardCalculator(RewardCalculator):
    ...
    SCHEDULE_BONUS = 0.1        # +0.1 when agent decide to command
    INVALID_PENALTY = -0.05     # -0.05 when agent waiting while work can be done
    IDLE_PENALTY_FACTOR = 0.01  # -0.01 if agent waste of resources
